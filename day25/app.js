...
walke;
wait;
wait, wait, walke, wait, vote, vomite, volunteer,
    volunteer, use, unpake, unpake, type, turn, tunr, ;
try { }
finally { }
travel, transfer, touch, tie, touch, thanke, thanke, thanke;
you, tanke;
thanke, tie, taste, talk, talk, talk, swallow,
    ...
    sneeze, smoke, smile, smile, smell, sign, shorten, shorten, shorten, shop, shave, shave, share, shave, shorten, serve, serve, serve,  == separate == , select, schedule, schedule, save, ;
return ,
    retire, retire, retire, request, request, request, request, request, ;
return , retire, request, request, remove, remiain, remain, remain, remain, remain, remain, relax, relax, register,
